...
//             `Hello! My name is ${name}. My phone number is ${phoneNumber}. Message: ${message}`
//         )}`;
...
export default function Contact() {
    ...
    const handleSubmit = (e) => {
        ...
        // Construct the WhatsApp URL
        const whatsappURL = `https://wa.me/${personalWhatsAppNumber}?text=${encodeURIComponent(
            `Hello! My name is ${firstName} ${lastName}. My phone number is ${phoneNumber}. Message: ${message}`
        )}`;
